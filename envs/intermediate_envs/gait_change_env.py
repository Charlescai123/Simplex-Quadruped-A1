...
from locomotion.robots import MotorControlMode, a1_robot
from locomotion.robots import gamepad_reader, a1
from locomotion.robots import MotorCommand
...
class GaitChangeEnv(gym.Env):
  ...
  def __init__(self,
    ...
    p.setAdditionalSearchPath('locomotion/data')
